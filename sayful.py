...
██
 .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
| |    _______   | || |      __      | || |  ____  ____  | || |  _________   | || | _____  _____ | || |   _____      | |
| |   /  ___  |  | || |     /  \     | || | |_  _||_  _| | || | |_   ___  |  | || ||_   _||_   _|| || |  |_   _|     | |
| |  |  (__ \_|  | || |    / /\ \    | || |   \ \  / /   | || |   | |_  \_|  | || |  | |    | |  | || |    | |       | |
| |   '.___`-.   | || |   / ____ \   | || |    \ \/ /    | || |   |  _|      | || |  | '    ' |  | || |    | |   _   | |
| |  |`\____) |  | || | _/ /    \ \_ | || |    _|  |_    | || |  _| |_       | || |   \ `--' /   | || |   _| |__/ |  | |
| |  |_______.'  | || ||____|  |____|| || |   |______|   | || | |_____|      | || |    `.__.'    | || |  |________|  | |
| |              | || |              | || |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
...
"""%(N))                                                    
───────────────────────────────────────────────────────
 [\x1b[1;96m+%s] Nama       : SAYFUL
 [\x1b[1;96m+%s] WhatsApp   : 01326368861
 [\x1b[1;96m+%s] Facebook   : SAYFUL ISLAM YT 
 [\x1b[1;96m+%s] Github      : https://github.com/Sayful001/sayfulL.git
───────────────────────────────────────────────────────\n'''%(N,N,N,N))
def kontol():
    os.system("clear")
...
""")#line:49
    ...
    if OOO00O0OOO00OO00O in ['1','01']:#line:51
      print (f"{H}[{P}!{H}]{P} Anda Akan Diarahkan Ke Whatsapp...");time .sleep (3 );os .system ('xdg-open https://wa.me/6283800144901?text=Bang+Yogi+Beli+Lisensi');exit ()#line:52
